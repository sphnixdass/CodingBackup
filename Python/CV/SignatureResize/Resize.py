...
def cropfunction(tempfoldername, tempfilename, tempinpputfile):
    ...
    for k in range(tempx + tempw,colcount):
        ...
        if tempcalempty > tempcalbreakvalue and tempcalflag == True:
            ...
            break
    cv2.imwrite(tempfoldername + tempfoldersplit + tempfilename.lower().replace(".png","").replace("jpg","") + 'rOutput.png', im_bw[tempy:tempy+temph, tempx:tempx+tempw])
    #extending left
    tempcal =0
    tempcalempty = 0
    tempcal2 =0
    ...
    for k in range(tempx, 1, -1):
        ...
        if tempcalempty > tempcalbreakvalue and tempcalflag == True:
            ...
            break
    cv2.imwrite(tempfoldername + tempfoldersplit + tempfilename.lower().replace(".png","").replace("jpg","") + 'LOutput.png', im_bw[tempy:tempy+temph, tempx:tempx+tempw])
    #extending bottom
    tempcal =0
    tempcalempty = 0
    tempcal2 =0
    ...
    for k in range(tempy + temph, rowcount):
        ...
        if (tempcal2 - tempcal) != 0 and (tempcal - tempcal2)  < tempmaxlifetickness:
            ...
            tempcalflag = True
        tempcal2 = tempcal
        cv2.imwrite('Test2.png', im_bw[tempy + temph:k + 1,tempx:tempx + tempw])
        if tempcalempty > tempcalbreakvalue and tempcalflag == True:
            temph = (k - tempy)
            break
        elif tempcalempty > tempcalbreakvalue and tempcalflag == False:
            break
    cv2.imwrite(tempfoldername + tempfoldersplit + tempfilename.lower().replace(".png","").replace("jpg","") + 'BOutput.png', im_bw[tempy:tempy+temph, tempx:tempx+tempw])
    #extending top
    tempcal =0
    tempcalempty = 0
    tempcal2 =0
    ...
    cv2.imwrite(tempfoldername + tempfoldersplit + tempfilename.lower().replace(".png","").replace("jpg","") + 'Output.png', img_rotate_90_clockwise)
    #break
    # cv2.imwrite(tempfoldername + tempfoldersplit + 'Test.png', im_bw)
...
for x in os.listdir(tempfolderpath):
    if os.path.isdir(x):
        # print (tempfolderpath + tempfoldersplit + x)
        for x2 in os.listdir(tempfolderpath + tempfoldersplit + x):
            if (".png" or ".jpg" in x2.lower()):
                if not ("Output.png".lower() in x2.lower()):
                    print(tempfolderpath + tempfoldersplit + x + tempfoldersplit + x2)
                    cropfunction(tempfolderpath + tempfoldersplit + x, x2, tempfolderpath + tempfoldersplit + x + tempfoldersplit + x2)
